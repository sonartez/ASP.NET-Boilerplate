...
namespace LinhDang.KworkPractice.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly KworkPracticeDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = KworkPracticeConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(KworkPracticeDbContext context)
        {
            _context = context;
        }
